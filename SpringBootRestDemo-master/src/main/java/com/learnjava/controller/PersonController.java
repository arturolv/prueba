...
public class PersonController {
	...
	public void initIt() throws Exception {
		personList.add(new Person(1,"Jun Alonso", 35));
		personList.add(new Person(2,"Ana Sanchez", 15));
		personList.add(new Person(3,"Diego Cerretero", 35));
		personList.add(new Person(4,"Sonia Briviesca", 15));
